@AbapCatalog.sqlViewName: 'ZSUPTURNOVER'
...
@VDM.viewType: #BASIC
define view ZI_SUPPLIERTURNOVER
                                                        ...
                                                        and TaxCode.CndnRecordValidityEndDate > $session.system_date
{
  key  BP.BusinessPartner,
       ...
       POAccr.PurchaseOrderDate,
       @Semantics.amount.currencyCode: 'CompanyCodeCurrency'
       @DefaultAggregation: #SUM
       cast(POAccr.NetAmount * POItem._PurchaseOrder.ExchangeRate as abap.curr(13,2))             as Amount,
       @Semantics.amount.currencyCode: 'CompanyCodeCurrency'
       @DefaultAggregation: #SUM
       cast(POAccr.NetAmount * division( TaxCode.ConditionRateRatio, 100, 2 ) as abap.curr(13,2)) as TaxAmount,
       @Semantics.amount.currencyCode: 'CompanyCodeCurrency'
       @DefaultAggregation: #SUM
       case
      ...
      then cast(
             ...
             * ( 1 + division( TaxCode.ConditionRateRatio, 100, 10 ) )
             * cast(POItem._PurchaseOrder.ExchangeRate as abap.decfloat34)
             as abap.curr(13,2)
           )
      else cast(POAccr.NetAmount * POItem._PurchaseOrder.ExchangeRate as abap.curr(13,2))
